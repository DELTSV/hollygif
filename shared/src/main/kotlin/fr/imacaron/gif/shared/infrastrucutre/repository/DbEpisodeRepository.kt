...
class DbEpisodeRepository(
	...
	override fun getSeasonEpisodes(season: SeasonEntity, page: Int, pageSize: Int): Result<List<EpisodeEntity>> =
	...
	override fun getSeasonEpisodesCount(season: SeasonEntity): Result<Int> =
		Result.success(db.episodes.count { EpisodeTable.season eq season.id })

	override fun getSeasonEpisode(season: SeasonEntity, number: Int): Result<EpisodeEntity> =
	...
	override fun addEpisode(episode: EpisodeEntity): Result<EpisodeEntity> {
