...
-- changeset macaron:1744029279982-1
ALTER TABLE TRANSCRIPTIONS DROP FOREIGN KEY TRANSCRIPTIONS_EPISODES_ID_FK;

-- changeset macaron:1744029279982-3
ALTER TABLE GIFS ADD keep TINYINT DEFAULT 0 NOT NULL;

-- changeset macaron:1744029279982-2
ALTER TABLE TRANSCRIPTIONS ADD CONSTRAINT TRANSCRIPTIONS_EPISODES_ID_FK FOREIGN KEY (id_episode) REFERENCES EPISODES (id_episode) ON UPDATE CASCADE ON DELETE CASCADE;